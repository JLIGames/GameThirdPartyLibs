\hypertarget{cexport_8h}{\section{assimp/assimp-\/3.1.1/include/assimp/cexport.h File Reference}
\label{cexport_8h}\index{assimp/assimp-\/3.\+1.\+1/include/assimp/cexport.\+h@{assimp/assimp-\/3.\+1.\+1/include/assimp/cexport.\+h}}
}


Defines the C-\/\+A\+P\+I for the \hyperlink{class_assimp}{Assimp} export interface.  
...
\item 
A\+S\+S\+I\+M\+P\+\_\+\+A\+P\+I ai\+Return \hyperlink{cexport_8h_a9615510b8430a9da4f435a72148128dd}{ai\+Export\+Scene} (const C\+\_\+\+S\+T\+R\+U\+C\+T \hyperlink{structai_scene}{ai\+Scene} $\ast$p\+Scene, const char $\ast$p\+Format\+Id, const char $\ast$p\+File\+Name, unsigned int p\+Preprocessing)
\item 
...
Create a modifiable copy of a scene. This is useful to import files via \hyperlink{class_assimp}{Assimp}, change their topology and export them again. Since the scene returned by the various importer functions is const, a modifiable copy is needed. 
...
\hypertarget{cexport_8h_adda7f2e6611f719af6c8a4a0bef0a0a2}{\index{cexport.\+h@{cexport.\+h}!ai\+Get\+Export\+Format\+Description@{ai\+Get\+Export\+Format\+Description}}
