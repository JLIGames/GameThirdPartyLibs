...
\hline
{\em p\+Type} & \hyperlink{struct_type}{Type} information hint \\
\hline
\end{DoxyParams}
...
Retrieve an array of \hyperlink{struct_type}{Type} values with a specific key from the material. 
...
\hline
{\em p\+Max} & Specifies the size of the given buffer, in \hyperlink{struct_type}{Type}'s. Receives the number of values (not bytes!) read. N\+U\+L\+L is a valid value for this parameter. \\
\hline
\end{DoxyParams}
...
Retrieve a \hyperlink{struct_type}{Type} value with a specific key from the material. 
...
\hline
{\em idx} & \hyperlink{struct_index}{Index} of the texture to be retrieved. \\
\hline
...
{\em type} & Specifies the type of the texture to be retrieved ( e.\+g. diffuse, specular, height map ...) \\
\hline
{\em index} & \hyperlink{struct_index}{Index} of the texture to be retrieved. The function fails if there is no texture of that type with this index. \hyperlink{structendif_a1b5fc4d41cee008c631531272d79d741}{Get\+Texture\+Count()} can be used to determine the number of textures per texture type. \\
\hline
...
\item 
assimp/assimp-\/3.\+1.\+1/include/assimp/\hyperlink{material_8h}{material.\+h}\end{DoxyCompactItemize}
