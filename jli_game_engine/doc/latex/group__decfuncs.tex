\hypertarget{group__decfuncs}{\section{Functions for Decoding}
...
\hypertarget{group__decfuncs_ga0ef07a9a97849054aa606c595a2d807e}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+alloc@{th\+\_\+decode\+\_\+alloc}}
...
\hypertarget{group__decfuncs_ga1a8051958d75b1012573b6e3c8f670e1}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+ctl@{th\+\_\+decode\+\_\+ctl}}
...
\begin{DoxyParams}{Parameters}
{\em \+\_\+dec} & A \hyperlink{structth__dec__ctx}{th\+\_\+dec\+\_\+ctx} handle. \\
\hline
...
\hline
\end{DoxyParams}
\hypertarget{group__decfuncs_gafb6684ad8ba507b71112bc9de148e7d0}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+free@{th\+\_\+decode\+\_\+free}}
...
\hline
\end{DoxyParams}
\hypertarget{group__decfuncs_ga006d01d36fbe64768c571e6a12b7fc50}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+headerin@{th\+\_\+decode\+\_\+headerin}}
...
\hypertarget{group__decfuncs_ga31c814bf09b2232aff69c57ae20f04eb}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+packetin@{th\+\_\+decode\+\_\+packetin}}
...
\begin{DoxyParamCaption}
\item[{{\bf th\+\_\+dec\+\_\+ctx} $\ast$}]{\+\_\+dec, }
\item[{const {\bf ogg\+\_\+packet} $\ast$}]{\+\_\+op, }
...
\hline
{\em \+\_\+granpos} & Returns the granule position of the decoded packet. If non-\/{\ttfamily N\+U\+L\+L}, the granule position for this specific packet is stored in this location. This is computed incrementally from previously decoded packets. After a seek, the correct granule position must be set via \hyperlink{theoradec_8h_a1e870c654d35394f0d490045df04e0f5}{T\+H\+\_\+\+D\+E\+C\+C\+T\+L\+\_\+\+S\+E\+T\+\_\+\+G\+R\+A\+N\+P\+O\+S} for this to work properly. \\
\hline
\end{DoxyParams}
...
\hline
{\em T\+H\+\_\+\+D\+U\+P\+F\+R\+A\+M\+E} & The packet represented a dropped (0-\/byte) frame. The player can skip the call to \hyperlink{group__decfuncs_gaa9cc8af63fa8540e0fc95572f259cdcb}{th\+\_\+decode\+\_\+ycbcr\+\_\+out()}, as the contents of the decoded frame buffer have not changed. \\
\hline
...
\hypertarget{group__decfuncs_gaa9cc8af63fa8540e0fc95572f259cdcb}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+decode\+\_\+ycbcr\+\_\+out@{th\+\_\+decode\+\_\+ycbcr\+\_\+out}}
...
Outputs the next available frame of decoded Y'Cb\+Cr data. If a striped decode callback has been set with \hyperlink{theoradec_8h_ac95cc9e109474b0fa4bb920ab2cfdf1e}{T\+H\+\_\+\+D\+E\+C\+C\+T\+L\+\_\+\+S\+E\+T\+\_\+\+S\+T\+R\+I\+P\+E\+\_\+\+C\+B}, then the application does not need to call this function. 
\begin{DoxyParams}{Parameters}
{\em \+\_\+dec} & A \hyperlink{structth__dec__ctx}{th\+\_\+dec\+\_\+ctx} handle. \\
\hline
...
\hypertarget{group__decfuncs_gadef55431b68aaa59d0d7b32b2f118f27}{\index{Functions for Decoding@{Functions for Decoding}!th\+\_\+setup\+\_\+free@{th\+\_\+setup\+\_\+free}}
...
Releases all storage used for the decoder setup information. This should be called after you no longer want to create any decoders for a stream whose headers you have parsed with \hyperlink{group__decfuncs_ga006d01d36fbe64768c571e6a12b7fc50}{th\+\_\+decode\+\_\+headerin()}. 
\begin{DoxyParams}{Parameters}
