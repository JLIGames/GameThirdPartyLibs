...
\index{run\+Test@{run\+Test}!Test\+Caller@{Test\+Caller}}
\subsubsection[{run\+Test}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Fixture $>$ void {\bf Test\+Caller}$<$ Fixture $>$\+::run\+Test (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\item 
assimp/assimp-\/3.\+1.\+1/contrib/cppunit-\/1.\+12.\+1/include/cppunit/Test\+Caller.\+h\end{DoxyCompactItemize}
