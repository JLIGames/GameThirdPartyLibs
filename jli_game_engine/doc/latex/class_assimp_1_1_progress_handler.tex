...
Each \hyperlink{class_importer}{Importer} instance maintains its own \hyperlink{class_progress_handler}{Progress\+Handler}. The default implementation provided by \hyperlink{class_assimp}{Assimp} doesn't do anything at all. 
...
\hline
\end{DoxyParams}
There are restriction on what you may do from within your implementation of this method\+: no exceptions may be thrown and no non-\/const \hyperlink{class_importer}{Importer} methods may be called. It is not generally possible to predict the number of callbacks fired during a single import.

\begin{DoxyReturn}{Returns}
Return false to abort loading at the next possible occasion (loaders and \hyperlink{class_assimp}{Assimp} are generally allowed to perform all needed cleanup tasks prior to returning control to the caller). If the loading is aborted, \#\+Importer\+::\+Read\+File() returns always N\+U\+L\+L.
\end{DoxyReturn}
\begin{DoxyNote}{Note}
...
\item 
assimp/assimp-\/3.\+1.\+1/include/assimp/\hyperlink{_progress_handler_8hpp}{Progress\+Handler.\+hpp}\end{DoxyCompactItemize}
